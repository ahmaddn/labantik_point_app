        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow flex items-center gap-3">
                    <a href="{{ route('superadmin.actions') }}" class="btn bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-zink-600 dark:hover:bg-zink-500 dark:text-zink-200 px-3 py-1.5 rounded-lg text-sm flex items-center gap-1">
                ...
                <ul class="flex shrink-0 items-center gap-2 text-sm font-normal">
                    ...
                    <li
                        class="before:font-remix dark:text-zink-200 relative before:absolute before:-top-[3px] before:text-[18px] before:text-slate-400 before:content-['\ea54'] ltr:pr-4 ltr:before:-right-1 rtl:pl-4 rtl:before:-left-1">
                        <a href="{{ route('superadmin.actions') }}" class="dark:text-zink-200 text-slate-400">Daftar Tindakan</a>
                    </li>
