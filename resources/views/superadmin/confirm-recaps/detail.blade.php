        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex shrink-0 items-center gap-2 text-sm font-normal">
                    ...
                    <li
                        class="before:font-remix dark:text-zink-200 relative before:absolute before:-top-[3px] before:text-[18px] before:text-slate-400 before:content-['\ea54'] ltr:pr-4 ltr:before:-right-1 rtl:pl-4 rtl:before:-left-1">
                        <a href="{{ route('superadmin.confirm-recaps') }}" class="dark:text-zink-200 text-slate-400">Rekap &
                            Verifikasi Pelanggaran</a>
                    </li>
                ...
                <div class="card-body p-5">
                    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
                        ...
                        <div class="flex gap-2">
                            <form action="{{ route('superadmin.confirm-recaps.reset-student', $studentAcademicYear->id) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus seluruh data pelanggaran, tindakan, dan pemotongan poin siswa ini secara permanen untuk simulasi?')">
                                @csrf
                            ...
                            <!-- Total Poin Terverifikasi -->
                             <div class="flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-4 transition-all hover:shadow-md dark:border-zink-600 dark:bg-zink-700 flex-1">
                                 ...
                                 @if($totalVerifiedPoints > 0)
                                     <form action="{{ route('superadmin.confirm-recaps.reset', $studentAcademicYear->id) }}" method="POST" class="inline-block shrink-0">
                                         @csrf
                                        ...
                                        <tr class="border-b bg-white hover:bg-slate-50/50 dark:border-zink-600 dark:bg-zink-700 dark:hover:bg-zink-600/50">
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <div class="flex justify-center items-center gap-2">
                                                    ...
                                                    @endphp
                                                    @if($actionType !== 'lisan')
                                                        <a href="{{ route('superadmin.actions.print', $history->id) }}" target="_blank"
