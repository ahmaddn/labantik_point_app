        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('guru.violations') }}" class="space-y-4" id="filterForm">
                                                ...
                                                <div id="editViolationModal{{ $violation->id }}" modal-center
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('guru.violations.update', $violation->id) }}">
                                                                @csrf
                                                                @method('PUT')
                                                ...
                                                <div id="deleteViolationModal{{ $violation->id }}" modal-center
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="p-4">
                                                            ...
                                                            <form
                                                                action="{{ route('guru.violations.destroy', $violation->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="flex justify-center gap-2">
                    ...
                    <div id="addViolationModal" modal-center
                        ...
                        <div class="dark:bg-zink-600 w-screen rounded-md bg-white shadow md:w-[30rem]">
                            ...
                            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                <form method="POST" action="{{ route('guru.violations.add') }}">
                                    @csrf
                                    <div id="alert-error-msg"
                                        class="hidden rounded-md border border-transparent bg-red-50 px-4 py-3 text-sm text-red-500 dark:bg-red-500/20">
                                    </div>
