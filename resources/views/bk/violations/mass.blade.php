...
@section('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            let currentPage  = 1;
            let filteredRows = [];
            // checkedIds: simpan id yang dipilih lintas halaman
            ...
            // Ambil semua data dari hidden store
            ...
            function renderPage(page) {
                ...
                slice.forEach(function (row) {
                    ...
                    // Sinkron perubahan checkbox ke checkedIds
            ...
            function renderPagination() {
                ...
                // Tombol Prev
                const prev = makeBtn('&laquo;', currentPage === 1, () => renderPage(currentPage - 1));
                ...
                // Tombol Next
                const next = makeBtn('&raquo;', currentPage === totalPages, () => renderPage(currentPage + 1));
            ...
            function syncSelectAll() {
                const visibleCheckboxes = container.querySelectorAll('.student-checkbox');
