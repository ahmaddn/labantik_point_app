...
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: center">
    <span style="font-family: Arial">Nomor :</span> <span style="font-family: Arial">{{ $reference_number ?? '' }}</span>
</p>
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: center">
...
<p style="margin-top: 0pt; margin-bottom: 0pt; line-height: 150%">
    <span style="font-family: Arial">Yang bertanda tangan dibawah ini :</span>
</p>
<p style="margin-top: 0pt; margin-bottom: 0pt; line-height: 150%">
    <span style="font-family: Arial">&nbsp;</span>
</p>
<p
    ...
    <span style="font-family: Arial">Nama</span><span
        ...
        style="font-family: Arial">{{ $student_name ?? '' }}</span>
</p>
<p
    style="
        margin-top: 0pt;
    ...
    <span style="font-family: Arial">Kelas</span><span
        ...
        ">&nbsp;</span><span
        style="font-family: Arial">:</span><span style="font-family: Arial">&nbsp;&nbsp;</span><span
        style="font-family: Arial">{{ $kelas ?? '' }}</span>
</p>
<p
    style="
        margin-top: 0pt;
    ...
    <span style="font-family: Arial">NIS</span><span
        ...
        ">&nbsp;</span><span
        style="font-family: Arial">:</span><span style="font-family: Arial">&nbsp;&nbsp;</span><span
        style="font-family: Arial">{{ $student_nis ?? '' }}</span>
</p>
<p
    style="
        margin-top: 0pt;
    ...
    <span style="font-family: Arial">NISN</span><span
        ...
        ">&nbsp;</span><span
        style="font-family: Arial">:</span><span style="font-family: Arial">&nbsp;&nbsp;</span><span
        style="font-family: Arial">{{ $student_nisn ?? '' }}</span>
</p>
<p style="margin-top: 0pt; margin-bottom: 0pt; line-height: 150%">
    <span style="font-family: Arial">&nbsp;</span>
</p>
<p
    style="
        ...
        line-height: 150%;
    ">
    <span style="font-family: Arial">Berjanji untuk tidak melakukan perbuatan/pelanggaran terhadap peraturan sekolah:</span>
</p>
...
<p
    style="
        ...
        line-height: 150%;
    ">
    <span style="font-family: Arial">Apabila saya hari ini tanggal {{ $prey ?? '' }} sampai dengan seterusnya saya terbukti mengulangi perbuatan tersebut saya bersedia untuk dikeluarkan dari sekolah ini.</span>
</p>
<p
    style="
        margin-top: 0pt;
        ...
        line-height: 150%;
    ">
    <span style="font-family: Arial">Demikian Surat Perjanjian ini saya buat dalam keadaan sehat jasmani dan tanpa paksaan dari pihak manapun.</span>
</p>
<p style="margin-top: 0pt; margin-bottom: 0pt">
    <span style="font-family: Arial">&nbsp;</span>
</p>
    ...
    <tbody>
        <tr>
            ...
            <td
                ...
                ">
                <p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 12pt">
                    <span style="font-family: Arial">Talaga, {{ $prey ?? '' }}</span>
                </p>
                <p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 12pt">
                ...
                <p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 8pt">
                    <span style="font-family: Arial; color: #808080">Materai 10000</span>
                </p>
                <p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 12pt">
                    <span style="font-family: Arial">&nbsp;</span>
                </p>
...
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: center">
    <strong><u><span
                style="font-family: Arial">{{ $kepala_sekolah->name ?? '' }}&nbsp;</span></u></strong>
</p>
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: center">
