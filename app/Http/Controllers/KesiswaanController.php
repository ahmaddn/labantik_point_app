...
class KesiswaanController extends Controller
{
    public function index()
    {
        ...
        return view('kesiswaan.dashboard.index', compact('studentAcademicYears', 'vals', 'activeAcademicYear'));
    }
    ...
    public function recaps(Request $request)
    {
        ...
        return view('kesiswaan.dashboard.recaps', compact('recaps', 'activeAcademicYear', 'handlingOptions'));
    }
}
